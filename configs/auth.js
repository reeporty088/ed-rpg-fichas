(function () {
  ...
  const defaultSheets = [
    { id: 'v1_ficha',      name: 'Ficha ED v1',       photo: '🧾', url: 'v1/ed_sistemav1_ficha.html',      version: 'v1' },
    { id: 'v2_ficha',      name: 'Ficha ED v2',       photo: '📘', url: 'v2/ed_sistemav2_ficha.html',      version: 'v2' },
    { id: 'v3_ficha_base', name: 'Ficha ED v3 - Base',photo: '🎭', url: 'index.html?ver=v3&tab=fichas', version: 'v3' },
    { id: 'v4_ficha_base', name: 'Ficha ED v4 - Base',photo: '⚔️', url: 'index.html?ver=v4&tab=fichas', version: 'v4' }
  ];
  ...
  function requireAuth(version) {
    ...
    const isSubdir = /\/(v[1-4])\//i.test(location.pathname);
    const redirectUrl = isSubdir ? '../index.html' : 'index.html';
    if (!user) { window.location.href = redirectUrl; return; }
